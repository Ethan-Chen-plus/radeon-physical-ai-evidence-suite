...
RoboCasa365 | DexJoCo | DISCOVERSE | Every Embodied | PAC-MAN
                              |
                 ROCm PyTorch and ROCm JAX
                              |
       SmolVLA | Pi0/Pi0.5 | ACT | GR00T | CBF
                              |
       task predicates | JSON | video | telemetry | SHA
```
...
- public source release with AMD training, evaluation, and profiling tools;
- English 14-page technical report;
- English 4:59 1080p demonstration video;
