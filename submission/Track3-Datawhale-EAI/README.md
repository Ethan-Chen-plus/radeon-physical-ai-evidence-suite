...
| Frozen source revision | [v1.0.0-amd-hackathon](https://github.com/Ethan-Chen-plus/radeon-physical-ai-evidence-suite/releases/tag/v1.0.0-amd-hackathon) |
...
| Supplementary showcase | [English/Chinese interactive site](https://ethan-chen-plus.github.io/amd-physical-ai-showcase/) |
